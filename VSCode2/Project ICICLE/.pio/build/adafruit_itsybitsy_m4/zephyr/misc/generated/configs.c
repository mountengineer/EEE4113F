...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PINMUX_SAM0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ADAFRUIT_ITSYBITSY_M4_EXPRESS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_SAMD51, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CPU_HAS_ARM_MPU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_SAM0, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_ATMEL_SAMD5X_OSCULP32K_AS_MAIN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_SAMD51G19A, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_OFFSET, 0x4000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x78000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOTLOADER_BOSSA_ADAFRUIT_UF2, 1);
